...
const ShippingForm = () => (
  <div className="ui container" id="regForm">
    ...
    <form className="ui huge form" id="personalInfo">
      ...
      <h3 id="formText" className="ui inverted dividing header">Contact Info</h3>
      <div className="field">
      ...
      <h3 id="formText" className="ui inverted dividing header">Address</h3>
        ...
        <div className="fields">
          ...
          <div className="twelve wide field">
            <input type="text" name="shipping[address-2]" placeholder="Street Address"/>
          </div>
        </div>
    ...
    <h3 id="formText" className="ui inverted dividing header">Additional Details</h3>
      <div className="field">
      <div class="ui form">
        <div class="field">
          <label id="formText">Details</label>
          <textarea type="text"  rows="1" placeholder="Please add any necessary information here..."></textarea>
        </div>
      </div>
      </div>
      ...
      <div className="field">
        <div className="field">
          ...
          <div id="regBtn">
            <button className="ui large fluid orange button" type="submit">Proceed to Checkout</button>
          </div>
        </div>
      </div>
    </form>
