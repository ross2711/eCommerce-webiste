...
const AdminReg = () => (
  <div className="ui container" id="regForm">
    ...
    <form className="ui huge form" id="personalInfo">
      <h3 id="formText" className="ui inverted centered dividing header">Terms and Conditions</h3>
      <div className="ui form">
{/*        <label id="formText">Name</label>*/}
        <div id="formTextHoldingText"><LoremIpsumHoldingText/></div>
        <div id="formTextHoldingText"><LoremIpsumHoldingText/></div>
        <div id="formTextHoldingText"><LoremIpsumHoldingText/></div>
      </div>


    <h3 id="formText" className="ui inverted dividing header"></h3>
      ...
      <div className="field">
        <div className="field">
          ...
          <div id="regBtn">
            <button className="ui large fluid orange button" type="submit">Apply for an Admin Account</button>
          </div>
        </div>
      </div>
    </form>
